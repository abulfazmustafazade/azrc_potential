...
const LANG = {
  az: {
    ...
    'login.btn':'Daxil ol','login.hint':'ID kodunuzu bilmirsinizsə HR şöbəsinə müraciət edin',
  ...
  en: {
    ...
    'hipo.question':'Is this employee assessed as demonstrating High Potential (HiPo) characteristics according to criteria defined by Azərconnect?',
